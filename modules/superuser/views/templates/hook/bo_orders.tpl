...
{literal}
    ...
    <script type="text/javascript">
        var orders_super_user_list = {
            init: function() {
                orders_super_user_list.createSuperUserListDropdown();
            },
                        ...
                        items.each(function(){
                            ...
                            if (last_cell.length) {
                                ...
                                var button_container = last_cell.find('.btn-group'),
                                    button = orders_super_user_list.createSuperUserButton(id_order);
