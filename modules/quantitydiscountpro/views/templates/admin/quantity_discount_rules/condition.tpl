    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            ...
            *}
                                    ...
                                    <tr>
                                        <td class="col-xs-6">
                                            ...
                                            <script type="text/javascript">
                                                {if !$ajax}{literal}$(window).on('load', function() {{/literal}{/if}
            ...
            <div class="form-group condition_type_options_4 condition_type_options_5 condition_type_options_10">
                <div class="col-lg-11 col-lg-offset-1">
                    <p class="inline-label condition_type_options_4">{l s='- With the selected products bought -' mod='quantitydiscountpro'}</p>
                    <p class="inline-label condition_type_options_5">{l s='- In the selected products -' mod='quantitydiscountpro'}</p>
                    <div class="panel">
                    ...
                    <script>
                        $('document').ready(function() {
                            var businessHoursManager = $("#scheduleContainer").businessHours({
                                ...
                                dayTmpl:'<div class="dayContainer col-xs-3 col-md-2 col-lg-2"><div class="weekday"></div>' +
