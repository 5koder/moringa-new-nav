...
define('MP_TOKEN', "6f8a135645517ecfb6b8ba5cb4e32fe0");
...
class MPServer {
    ...
    function run() {
        ...
        if (!$this->_checkToken()) {
            $this->response->error('The bridge connector module generated for dev.moringaworld.co.za! Please, download again bridge connector module and install to the Source shop (old shop) and try connection again.', null);
            return;  
        }
