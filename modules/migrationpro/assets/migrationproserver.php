...
class Migrationproserver extends Module
{
	...
	if (!empty(Configuration::get('PS_MAINTENANCE_IP'))) {
            Configuration::updateValue('PS_MAINTENANCE_IP', Configuration::get('PS_MAINTENANCE_IP') . ', 129.232.155.40');
        } else {
            Configuration::updateValue('PS_MAINTENANCE_IP', '129.232.155.40');
        }
