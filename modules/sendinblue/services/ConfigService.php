...
class ConfigService
{
    ...
    const SIB_INTEGRATIONS_API_URL = 'https://app.sendinblue.com/integrations/api';
    ...
    const SEND_TEST_CONTENT = 'content';
    const SEND_TEST_SUBJECT = 'Sendinblue Test Mail';
    const SEND_TEST_TYPE = 'text/html';
