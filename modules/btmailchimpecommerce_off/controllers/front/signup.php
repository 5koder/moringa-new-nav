...
class BTMailchimpEcommerceSignupModuleFrontController extends ModuleFrontController
{
    /**
    ...
    /**
     * method init module front controller content
     *
     * @throws Exception
     * @return bool
     */
    public function initContent()
    {
        ...
        $oHook = new \MCE\HookCtrl('display', 'dedicatedSignup');
