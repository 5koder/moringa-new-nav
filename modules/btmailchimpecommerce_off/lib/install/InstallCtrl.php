...
class BT_InstallCtrl
{
    ...
    /**
     * rexecute matched install object
     *
    ...
    public static function run($sAction, $sInstallType, $mParam = null)
    {
        ...
        if (in_array($sAction, self::$_aDefaultAction)) {
            ...
            require_once(_MCE_PATH_LIB_INSTALL . 'Install.php');

            switch ($sInstallType) {
                case 'sql' :
                    // include matched installation object
                    require_once(_MCE_PATH_LIB_INSTALL . 'InstallSql.php');
                ...
                case 'config' :
                    // include matched installation object
                    require_once(_MCE_PATH_LIB_INSTALL . 'InstallConfig.php');
                ...
                case 'tab' :
                    // include matched installation object
                    require_once(_MCE_PATH_LIB_INSTALL . 'InstallTab.php');
