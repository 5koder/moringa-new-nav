    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="register_home">
                ...
                <form action="https://moringaworld.co.za/login?create_account=1" id="customer-form" method="post">
                    <div class="form-group row align-items-center ">
                        ...
                        <div class="col-md-3">
                            <input class="form-control" name="email" type="email" value="" placeholder="Email Address" required>
                        </div>
                        <div class="col-md-3">
                            <button type="submit" class="btn btn-primary btn_custom">Sign Up Now</button>
                        </div>
                    </div>
                </form>
            </div>
