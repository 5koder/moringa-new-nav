        ...
        <div class="row align-items-center">
            ...
            <div class="col {if $iqitTheme.h_logo_position == 'left'}col-auto{/if} col-header-right">
                <div class="row no-gutters justify-content-end">
                    ...
                    <div class="col col-auto header-btn-w col-mobile-menu-push">
                        <a data-toggle="dropdown" data-display="static" aria-expanded="false" class="header-btn header-user-btn"><i aria-hidden="true" class="fa fa-bars icon"></i>
                        ...
                        <div id="_mobile_iqitmegamenu-mobile" class="text-left dropdown-menu-custom dropdown-menu">
                            <div id="iqitmegamenu-mobile"> 
                                <div class="dektop-menu-title">
                                    <span class="modal-title">Main Menu</span>
                                    <button id="desktop_close_menu" type="button" class="close">
                                        <span>×</span>
                                    </button>
                                    <hr>
                                </div>
                                ...
                                <div class="row no-gutters">
                                    ...
                                    {hook h="litespeedEsiBegin" m="iqitwishlist" field="widget_block" tpl="module:iqitwishlist/display-header-buttons-mobile.tpl"}
                                    {widget_block name="iqitwishlist"}
                                        {include 'module:iqitwishlist/views/templates/hook/display-header-buttons-mobile.tpl'}
                                    {/widget_block}
                                </div>
                    ...
                    <div class="col col-auto header-btn-w">
                        <div class="header-custom-html">
                            <p><a href="/login?create_account=1"><button type="submit" class="btn btn-primary btn-md">Get 20% Off</button></a></p>
                        </div>
                    </div>
                </div>
