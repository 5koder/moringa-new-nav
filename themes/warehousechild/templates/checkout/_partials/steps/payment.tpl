        ...
        {foreach from=$conditions_to_approve item="condition" key="condition_name"}
          <li>
              ...
              <span class="custom-checkbox">
                ...
                I agree to the <a href="/moringa/terms-and-conditions-of-use" id="cta-terms-and-conditions-0">terms and conditions</a>.
              </label>
              </span>
          </li>
        {/foreach}
    ...
    <div class="ps-shown-by-js">
      <button type="submit" {if !$selected_payment_option} disabled {/if} class="btn btn-primary btn-block btn-lg">
        ...
        <article class="alert alert-danger m-t-2 js-alert-payment-conditions" role="alert" data-alert="danger">
          Please make sure you've chosen a <strong>payment method</strong> and accepted the <strong>terms and conditions</strong> above.
        </article>
    </div>
